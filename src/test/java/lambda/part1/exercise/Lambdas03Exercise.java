...
public class Lambdas03Exercise {
    ...
    public void generic1() {
        ...
        final GenericProduct<Integer> prod = (num1, num2) -> num1 * num2;

        assertEquals(prod.prod(3, 2), Integer.valueOf(6));
    }

    private static Integer intProd(int a, int b){
        return a * b;
    }
    ...
    public void generic2() {
        ...
        final GenericProduct<Integer> prod = Lambdas03Exercise::intProd;
